export const navLinks = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Budgets', href: '/budget-reporting/', icon: 'fas fa-chart-pie' },
      { label: 'By-Laws', href: '/by-laws/', icon: 'fas fa-gavel' },
      { label: 'Financial Statements', href: '/financial-statements/', icon: 'fas fa-file-invoice-dollar' },
      { label: 'IDP', href: '/idp/', icon: 'fas fa-sitemap' },
      { label: 'Performance Agreements', href: '/performance-agreements/', icon: 'fas fa-file-contract' },
      { label: 'Performance Reports', href: '/performance-reports/', icon: 'fas fa-chart-line' },
      { label: 'Policies', href: '/policies/', icon: 'fas fa-clipboard-list' },
      { label: 'SDBIP', href: '/sdbip/', icon: 'fas fa-tasks' },
      { label: 'In-Year Reporting', href: '/in-year-reporting/', icon: 'fas fa-calendar-check' },
    ],
  },
  {
    label: 'Events & Media',
